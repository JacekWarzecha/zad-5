...
public class PatientController {
    ...
    public ResponseEntity<Patient> updatePatient (@PathVariable @Valid String pesel, @RequestBody @Valid Patient patient){
    ...
    public ResponseEntity<Void> deletePatient(@PathVariable @Valid String pesel){
